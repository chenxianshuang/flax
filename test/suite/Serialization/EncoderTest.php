...
class EncoderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testEncodeObjectWithCircularReference()
    {
        ...
        $this->assertSameBinary("C\x08stdClass\x92\x01a\x01b\x60NQ\x90", $this->encoder->encode($object));
    }
    ...
    public function testEncodeUnsupportedType()
    {
        ...
        $this->setExpectedException('Icecave\Flax\Exception\EncodeException', 'Can not encode value of type "resource".');
